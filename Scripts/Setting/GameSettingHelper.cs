...
namespace FirstBattle
{
    public class GameSettingHelper : SettingHelperBase
    {
        ...
        private GameSetting m_Settings = null;
        private GameSettingSerializer m_Serializer = null;
        ...
        /// 获取游戏配置序列化器。
        /// </summary>
        public GameSettingSerializer Serializer
        {
            get
            {
                return m_Serializer;
        ...
        private void Awake()
        {
            ...
            m_Serializer.RegisterDeserializeCallback(0, DeserializeGameSettingCallback);
        }

        private bool SerializeGameSettingCallback(Stream stream, GameSetting defaultSetting)
        {
            m_Settings.Serialize(stream);
            return true;
        }

        private GameSetting DeserializeGameSettingCallback(Stream stream)
        {
